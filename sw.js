...
self.addEventListener('push', (event) => {
  ...
  const section = tag.startsWith('result') || tag.startsWith('reminder') || tag.startsWith('streak')
    ? '#pronosticos'
    : tag.startsWith('leaderboard') || tag.startsWith('ranking')
      ? '#clasificacion'
      : tag.startsWith('badge')
        ? '#perfil'
        : '';
